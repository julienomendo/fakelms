<?php
	 ...
	 * Time: 11:44
	 */
	if(isset($_GET['t']) && $_GET['t'] == 'hwlkfdjhwskcvlnw_ksjhdqizsudkgserhytr5675274'){
		...
		$relativePathGetted = isset($_GET[ 'scorm_seq_file' ]) ? '../courses/' . substr($_GET[ 'scorm_seq_file' ],
		                                                                                strlen(getcwd()) + 1) : '';
		...
		$output = str_replace('{{t}}', 'hwlkfdjhwskcvlnw_ksjhdqizsudkgserhytr5675274', $output);

		echo $output;
	}
	else
		die('ACCESS ERROR = NOT ALLOWED');
	?>
