...
function WriteSwfObject(strSwfFile, nWidth, nHeight, strScale, strAlign, strQuality, strBgColor, bCaptureRC, strFlashVars)
{
	...
	try
	{
		var scriptForEvent = document.createElement("script");
		scriptForEvent.setAttribute("for", "eplayer");
		scriptForEvent.event = "FSCommand(command, args)";       
		scriptForEvent.appendChild(document.createTextNode("player_DoFSCommand(command, args);"));
		document.body.appendChild(scriptForEvent);
	}
	catch (e) {}	
}
